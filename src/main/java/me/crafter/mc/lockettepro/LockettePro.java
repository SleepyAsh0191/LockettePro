...
public class LockettePro extends JavaPlugin {
    ...
    private void checkMcVersion() {
	    ...
	    if (version.matches("1.16") || version.matches("1.16.1") || version.matches("1.16.2") || version.matches("1.16.3") || version.matches("1.16.4") || version.matches("1.16.5") || version.matches("1.17") || version.matches("1.17.1") || version.matches("1.18") || version.matches("1.18.1")) {
